  ...
  private function pruebas(){
    ...
    if ($axion=="agrega"){
        ...
        if ($cardetid>0){
          ...
          $query=mysqli_query($con, "INSERT INTO doccarrosdet (doccarid, doctraid, traid, cantidad, empreid, userid, pesoreal) VALUES ('$doccarid', '$doctraid', '$traid', '$cantidad', '$empreid', '$userid', '$pesoreal')");

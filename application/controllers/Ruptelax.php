    ...
    if ($rup1>0){
      ...
      if ($query) {
        ...
        if ($query) {
          ...
          $xsql = "Insert Into gpsviajes set vehid=$vehid, fecha='$fecha', lat1=$this->lat1, lon1=$this->lon1, lat2=$this->lat2, lon2=$this->lon2, tipo='Auto', Estatus='Actual', fecha1='$fecha', numedo=$numedo, rupid1=$rupini ";
          $query = $this->db->query($xsql);
          if ($query) {

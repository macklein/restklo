...
/************************************************************************/
 public function login_post(){
    ...
    //  $token = utf8_encode(password_hash($mytok,  PASSWORD_DEFAULT));
      ...
      $xsql = "INSERT INTO usersesion SET UserId=$row->user_id, UserName='$row->user_name', FechaHora='$fecha', MyToken='$mytok', Estatus='Actual', nompc='$nompc', tcpip='$localIP' "; //, Token='".$token."'";

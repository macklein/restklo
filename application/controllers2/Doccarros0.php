...
*/
  ...
  $campos="doccarros.doccarid, doccarros.sello, DATE_FORMAT(fecha,'%d/%m/%Y') AS fecha, clientes.nombre, left(clientesdir.descripcion,20) as descripcion, doccarros.carnum, doccarros.carid ";
